...
import png from '../../../public/logo1.png'
            ...
            <Container maxW={1300}>
                <SimpleGrid textAlign={{lg:'start',base:'center'}} spacing='30px' py='60px' templateColumns={{base:'repeat(1, 1fr)', lg:'repeat(4, 1fr)'}}>
                    <Box >
                        ...
                        <Image m={{base:'auto',lg:'0'}} src='/logo1.png' alt='Panaverse'></Image>
                    ...
                    <Box>
                        ...
                        <Grid pt='40px' color='gray'>
                            <Link href='/'>+92 300 2652469</Link>
                            <Link href='/'>zahidibrahim.usa@gmail.com</Link>
